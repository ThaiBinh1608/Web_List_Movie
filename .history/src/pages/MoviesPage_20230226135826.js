...
const MoviesPage = () => {
  ...
  const currentItems = data.total_pages.slice(itemOffset, endOffset);
  const pageCount = Math.ceildata.total_pages / itemsPerPage

  // Invoke when user click to request another page.
  const handlePageClick = (event) => {
    const newOffset = (event.selected * itemsPerPage) % data.tot.length;
    console.log(
