...
function MovieVideo(){
  ...
  {results.slice(0,1).map(item =>(
    ...
    <h3 className="mb-5 text-xl font-medium p-3 bg-primary inline-block">Trailer Phim</h3>
    <div key={item.id} className='w-full aspect-video' > 
    <iframe width="900" height="506" src={`https://www.youtube.com/embed/${item.key}`} title="Youtube" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen
...
//<iframe width="900" height="506" src="https://www.youtube.com/embed/9tLHQyKBSb8" title="Kang Chinh Phục full đồ thua con kiến|Sao Kang yếu đến thế?" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
