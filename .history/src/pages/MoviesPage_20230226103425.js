...
const MoviesPage = () => {
    ...
    useEffect(() => {
        if(filterDebounce) {
            setUrl("https://api.themoviedb.org/3/search/movie?api_key=ccd2fb4b6c71b6649a8e1b8c8338a19e");
        }else {
            setUrl(`https://api.themoviedb.org/3/movie/popular?api_key=ccd2fb4b6c71b6649a8e1b8c8338a19e&query=${filterDebounce}")
        }
