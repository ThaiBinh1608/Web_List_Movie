...
const Header = () => {
    return (
        ...
        <header className="header flex  text-xl font-semibold items-center justify-between gap-x-5 text-white py-10 mb-5 ">
        <div className='text-5xl font text-left'>Z<span className='text-primary'>u</span>es</div>
